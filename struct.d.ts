...
type Compose <
	Assign extends object,
	Getter extends object,
	Setter extends object,
	Define extends object,
	Constant extends object,
...
> = (
	...
	& Readonly<(Define & Constant & Computed & Method)>
	& Extended<Extends>
);
...
> = {
	...
	getter?: {
		[ key in keyof Getter ]: (val: PickMutDef<key, Setter, Assign, Getter>, struct: Compose<Assign, Getter, Setter, Define, Constant, Computed, Method, PostExtended>) => Getter[key];
	} & ThisType<Compose<Assign, Getter, Setter, Define, Constant, Computed, Method, PostExtended>>;

	setter?: {
		[ key in keyof Setter ]: (next: PickMutDef<key, Assign, Getter, Setter>, struct: Compose<Assign, Getter, Setter, Define, Constant, Computed, Method, PostExtended>) => PickMutDef<key, Assign, Setter>;
	} & ThisType<Compose<Assign, Getter, Setter, Define, Constant, Computed, Method, PostExtended>>;
	...
	computed?: {
		[ key in keyof Computed ]: (struct: Compose<Assign, Getter, Setter, Define, Constant, Computed, Method, PostExtended>) => Computed[key];
	} & ThisType<Compose<Assign, Getter, Setter, Define, Constant, Computed, Method, PostExtended>>;
...
export const Struct: <
	...
	Extends extends StructExtends,
	Static extends object = {}
> (template: StructTemplate<Assign, Getter, Setter, Define, Constant, Computed, Method, Extends, Static>) => Struct<Compose<Assign, Getter, Setter, Define, Constant, Computed, Method, Extends>, keyof Constant, Static>;
